...
<body>
    <div class="container"> <br>
        <a href="{{route("produto.create")}}" class="btn btn-outline-dark">Criar um produto</a>
        <table class="table table-hover">
            ...
            @foreach ($produtos as $produto)
                <tr>
                    ...
                    <td>
                        <a href="{{route("produto.show", $produto->id)}}" class="btn btn-outline-primary">Mostrar</a>
                        <a href="{{route("produto.edit", $produto->id)}}" class="btn btn-outline-secondary">Editar</a>
                        <button type="button" class="btn btn-outline-danger btnRemover" data-bs-toggle="modal" data-bs-target="#exampleModal" value="{{route("produto.destroy", $produto->id)}}">Remover</button>
                    </td>
                </tr>
            @endforeach
            </tbody>
